...
@dataclass
class Contribuyente (ABC): #ABC significa que la clase es abstracta
    @abstractmethod
...
class Monotributista (Contribuyente):
    ...
    def calcular_sueldo(self) -> float:
        if self.sueldo < (370_000 / 12):
            return self.sueldo - 2646.22 #Si son menores a $370.000 (mensuales), paga $2646,22 mensuales
        elif self.sueldo < (550_000 / 12):
            return self.sueldo - 2958.95 #Si son menores a $550.000 (mensuales), paga $2958,95 mensuales
        elif self.sueldo < (770_000 / 12):
            return self.sueldo - 3382.62 #Si son menores a $770.000 (mensuales), paga $3382,62 mensuales
        else:
            return self.sueldo - 3988.85 #Si son mayores a $770.000 (mensuales), paga $3988,85 mensuales
...
cada uno."""
    sueldos_contribuyentes = []
    for contribuyente in contribuyentes:
        sueldos_contribuyentes.append(contribuyente.calcular_sueldo())
        print(sueldos_contribuyentes)
    return sueldos_contribuyentes
